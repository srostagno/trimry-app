...
const en: MessageSection = {
  ...
  home: {
    ...
    trustLine: 'Free by email and weekly on WhatsApp · Soccer, NBA, NFL, F1, UFC and more',
    ...
    finalSubtitle: 'Set it up in two minutes. Free by email and every week on WhatsApp.',
  },
  pricing: {
    eyebrow: 'Pricing',
    ...
    trialNote: 'Email and weekly WhatsApp are free. Pro is {billingCompact}.',
    includes: [
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'The agenda by email is free, at the cadence you pick, and so is a weekly agenda on WhatsApp. Pro sends the agenda to your WhatsApp every morning, with a short intro written for you. Cancel anytime.',
      },
      {
  ...
  onboarding: {
    ...
    startTrialCta: 'Activate my agenda',
    startTrialHint: 'Free by email and weekly on WhatsApp. Pro continues to Stripe checkout.',
  ...
  deliveryChannels: {
    ...
    whatsappPendingNote:
      'On the free plan the WhatsApp agenda arrives once a week, on Mondays. Every morning is Trimry Pro.',
  },
  pro: {
    badge: 'PRO',
    ...
    freeTagline: 'Email, plus WhatsApp once a week',
    freeFeatures: [
      'Your agenda by email, daily or weekly',
      'The week\'s agenda on WhatsApp, every Monday',
      'Every sport, league and team you follow',
      'Delivered at the hour you pick, in your time zone',
    ],
    proTitle: 'Pro',
    proPrice: '{price}/month',
    proTagline: 'Cancel anytime',
    proFeatures: [
      'Everything in Free',
      'Your agenda on WhatsApp every morning, not just Mondays',
      'A short intro written for you on top of every agenda',
    ],
    proRibbon: 'Recommended',
    choose: 'Choose',
    chosen: 'Selected',
    sheetTitle: 'Every morning on WhatsApp is Trimry Pro',
    sheetBody:
      'Pro sends your agenda straight to WhatsApp every morning instead of once a week, and opens it with a short summary written for you. Cancel anytime.',
    sheetBodyCheckout:
    ...
    sheetCta: 'Activate Pro',
    sheetDismiss: 'Stay on the free plan',
    sheetFinePrint:
      '{price} a month. Cancel anytime, and your email and weekly WhatsApp agenda keep coming either way.',
    statusPro: 'Pro',
    statusTrial: '{days} days of Pro left',
    statusFree: 'Free plan · WhatsApp weekly',
    statusFreeCta: 'See Pro',
    proRequiredNotice:
      'WhatsApp every morning is Trimry Pro. Activate it from your dashboard.',
  },
  delivery: {
...
const es: MessageSection = {
  ...
  home: {
    ...
    trustLine: 'Gratis por email y semanal por WhatsApp · Fútbol, NBA, NFL, F1, UFC y más',
    ...
    finalSubtitle: 'Configúrala en dos minutos. Gratis por email y cada semana por WhatsApp.',
  },
  pricing: {
    eyebrow: 'Precio',
    ...
    planTitle: 'Trimry Sports Alerts',
    billing: '{billingInline}',
    trialNote: 'Email y WhatsApp semanal son gratis. Pro cuesta {billingCompact}.',
    includes: [
  ...
  onboarding: {
    ...
    startTrialCta: 'Activar mi agenda',
    startTrialHint: 'Gratis por email y semanal por WhatsApp. Pro sigue al checkout de Stripe.',
  ...
  deliveryChannels: {
    ...
    whatsappPendingNote:
      'En el plan gratis la agenda por WhatsApp llega una vez por semana, los lunes. Cada mañana es Trimry Pro.',
  },
  pro: {
    badge: 'PRO',
    ...
    freeTagline: 'Email, más WhatsApp una vez por semana',
    freeFeatures: [
      'Tu agenda por email, diaria o semanal',
      'La agenda de la semana por WhatsApp, cada lunes',
      'Todos los deportes, ligas y equipos que sigas',
      'A la hora que elijas, en tu horario',
    ],
    proTitle: 'Pro',
    proPrice: '{price}/mes',
    proTagline: 'Cancelas cuando quieras',
    proFeatures: [
      'Todo lo del plan gratis',
      'Tu agenda en WhatsApp cada mañana, no solo los lunes',
      'Un resumen corto escrito para ti al abrir cada agenda',
    ],
    proRibbon: 'Recomendado',
    choose: 'Elegir',
    chosen: 'Elegido',
    sheetTitle: 'Cada mañana por WhatsApp es Trimry Pro',
    sheetBody:
      'Pro te manda la agenda directo a WhatsApp cada mañana en vez de una vez por semana, y la abre con un resumen corto escrito para ti. Cancelas cuando quieras.',
    sheetBodyCheckout:
    ...
    sheetCta: 'Activar Pro',
    sheetDismiss: 'Seguir con el plan gratis',
    sheetFinePrint:
      '{price} al mes. Cancelas cuando quieras, y tu agenda por email y tu WhatsApp semanal siguen llegando igual.',
    statusPro: 'Pro',
    statusTrial: 'Te quedan {days} días de Pro',
    statusFree: 'Plan gratis · WhatsApp semanal',
    statusFreeCta: 'Ver Pro',
    proRequiredNotice:
      'WhatsApp cada mañana es Trimry Pro. Actívalo desde tu panel.',
  },
  delivery: {
...
const pt: MessageSection = {
  ...
  home: {
    ...
    trustLine: 'Grátis por e-mail e semanal no WhatsApp · Futebol, NBA, NFL, F1, UFC e mais',
    ...
    finalSubtitle: 'Configure em dois minutos. Grátis por e-mail e toda semana no WhatsApp.',
  },
  pricing: {
    eyebrow: 'Preço',
    ...
    planTitle: 'Trimry Sports Alerts',
    billing: '{billingInline}',
    trialNote: 'E-mail e WhatsApp semanal são grátis. O Pro custa {billingCompact}.',
    includes: [
  ...
  faq: {
    ...
    items: [
      ...
      {
        question: 'O que é grátis e o que é Pro?',
        answer:
          'A agenda por e-mail é grátis, na frequência que você escolher, e uma agenda semanal no WhatsApp também. O Pro manda a agenda para o seu WhatsApp toda manhã, com um resumo curto escrito para você. Cancele quando quiser.',
      },
      {
  ...
  onboarding: {
    ...
    startTrialCta: 'Ativar minha agenda',
    startTrialHint: 'Grátis por e-mail e semanal no WhatsApp. O Pro segue para o checkout da Stripe.',
  ...
  deliveryChannels: {
    ...
    whatsappPendingNote:
      'No plano grátis a agenda no WhatsApp chega uma vez por semana, às segundas. Toda manhã é o Trimry Pro.',
  },
  pro: {
    badge: 'PRO',
    ...
    freeTagline: 'E-mail, mais WhatsApp uma vez por semana',
    freeFeatures: [
      'Sua agenda por e-mail, diária ou semanal',
      'A agenda da semana no WhatsApp, toda segunda',
      'Todos os esportes, ligas e times que você seguir',
      'No horário que você escolher, no seu fuso',
    ],
    proTitle: 'Pro',
    proPrice: '{price}/mês',
    proTagline: 'Cancele quando quiser',
    proFeatures: [
      'Tudo do plano grátis',
      'Sua agenda no WhatsApp toda manhã, não só às segundas',
      'Um resumo curto escrito para você no topo de cada agenda',
    ],
    proRibbon: 'Recomendado',
    choose: 'Escolher',
    chosen: 'Escolhido',
    sheetTitle: 'Toda manhã no WhatsApp é o Trimry Pro',
    sheetBody:
      'O Pro manda sua agenda direto no WhatsApp toda manhã em vez de uma vez por semana, e abre com um resumo curto escrito para você. Cancele quando quiser.',
    sheetBodyCheckout:
    ...
    sheetCta: 'Ativar o Pro',
    sheetDismiss: 'Continuar no plano grátis',
    sheetFinePrint:
      '{price} por mês. Cancele quando quiser, e sua agenda por e-mail e o WhatsApp semanal continuam chegando de qualquer jeito.',
    statusPro: 'Pro',
    statusTrial: 'Restam {days} dias de Pro',
    statusFree: 'Plano grátis · WhatsApp semanal',
    statusFreeCta: 'Ver o Pro',
    proRequiredNotice:
      'O WhatsApp toda manhã é o Trimry Pro. Ative pelo seu painel.',
  },
  delivery: {
    badge: 'Ajustes de entrega',
