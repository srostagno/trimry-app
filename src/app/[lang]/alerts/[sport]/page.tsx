...
// /en/alerts/football, /en/alerts/soccer (Spanish and Portuguese live under /alertas).
function resolve(params: Params['params']) {
  if (!isLanguageCode(params.lang) || !isLandingSegment(params.lang, 'alerts')) return null
